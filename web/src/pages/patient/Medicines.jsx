    ...
    <div className="min-h-screen bg-[#F7F3EE] w-full max-w-full overflow-x-hidden">
      ...
      <div className="w-full max-w-4xl mx-auto px-3 sm:px-6 py-4 sm:py-8 pb-safe">
        <div className="mb-4 sm:mb-6">
          <h1 className="text-xl sm:text-2xl font-bold text-gray-800">My Medicines</h1>
          <p className="text-gray-500 text-xs sm:text-sm mt-1">All prescribed medications across your visits</p>
        </div>
